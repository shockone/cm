...
//							// If you want to be able to dynamically enable and disable multiSelect, pass a string, as in data
//							if (typeof options.multiSelect === "string") {
//								var multiSelectWatcher = function (newMultiSelectValue) {
//									grid.multiSelect = newMultiSelectValue;
//								};
//								$scope.$parent.$watch(options.multiSelect, multiSelectWatcher);
//							}
